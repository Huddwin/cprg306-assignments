  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-4 m-2 border rounded">
      <div className="my-2">
        ...
        <input id="name" name="name" type="text" required value={item.name} onChange={handleChange} placeholder="e.g. milk, 4 L 🥛"  className="outline-1 p-2 w-full rounded-md text-blue-800"/>            
      </div>
